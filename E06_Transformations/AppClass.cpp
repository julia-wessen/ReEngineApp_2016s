...
void AppClass::InitVariables(void)
{
	...
	m_pTorus->GenerateTorus(0.5f, 0.2f, 0.5f, 10, REYELLOW);
	m_pTube->GenerateTube(0.5f, 0.2f, 0.5f, 10, REBROWN);
	m_pCylinder->GenerateCylinder(0.5f, 0.5f, 8, REBLUE);
	m_pCone->GenerateCone(0.5f, 0.5f, 5, REGREEN);
}
